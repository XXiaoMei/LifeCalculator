...
public class MenuActivity extends FragmentActivity implements View.OnClickListener{
    ...
    private void setUpMenu() {
        ...
        // create menu items;
        itemTesting  = new ResideMenuItem(this, R.drawable.icon_testing,"寿命计算");
        itemMe = new ResideMenuItem(this, R.drawable.icon_me, "个人信息");
        itemHistory  = new ResideMenuItem(this, R.drawable.icon_history,  "养生之道");
        itemHealthBar = new ResideMenuItem(this, R.drawable.icon_bar, "健康吧");
